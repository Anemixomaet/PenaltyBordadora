        ...
        <form>
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                @if(count($inscripciones) > 0)
                    <div class="mb-4">
                        <label class="inline-block w-32 font-bold">Inscripcion:</label>
                        <select name="id_inscripcion" wire:model="inscripcion_id" 
                            ...
                            @foreach($inscripciones as $inscripcione)
                                <option value="{{ $inscripcione->id }}">{{ $inscripcione->id }} </option>
                            @endforeach
                        </select>
                    </div>
                @endif
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="asistencia" wire:model="asistencia">
                </div>
